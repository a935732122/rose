...
<link rel="stylesheet" href="{{asset('home/css/list3.css')}}">
	...
	<div class="constrll">
		<div class="strll_te">
			...
			<div class="sagi_right">
				...
				<div class="liji">
					<a href="" class="mai" id="mai">立即购买</a>
				...
				<div style="margin-bottom:20px">
					...
					<div style="font-size: 18px;float: left;margin-right: 20px"> <a href="{{asset('home/show/talk')}}/{{$listi[0]['pdo_id']}}">商品评论</a></div>
				</div>
				<br>
				<br>
				<br>
