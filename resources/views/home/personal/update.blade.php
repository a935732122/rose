			...
			<div id="addressListDiv" style="float:left;width:80%;text-align: center">
			  <div class="mod_address">
				...
				<div class="manage-left" id="manage-left">编辑收货地址</div>
					<form  method="post" action="{{asset('home/personal/adupdate')}}">
					@foreach($mm as $v)
					<input type="hidden" id="addressid" name="id" value="{{$v['id']}}" />
						...
						<table width="700" height="150" border="0" cellspacing="0">
							...
							<tr>
								...
								<td align="left" class="cor-2"><input id="mobile" class="txt"
									type="text" maxlength="11" name="phone" value="{{$v['phone']}}"
									style="width:200px; height:30px; border:solid 1px #ededed;"
									 />
								</td>
							</tr>		
							<tr>			
								...
								<td align="left" class="cor-2"><input id="address_email"
									class="txt" type="text" value="{{$v['email']}}" name="email"
									style="width:200px; height:30px; border:solid 1px #ededed;" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left" colspan="3" class="cor-2"><span
									...
									class="txt" type="text" maxlength="50" value="{{$v['address']}}"
