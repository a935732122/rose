	...
	<div class="aheader">
			<div class ="logo">
				...
				<a href="{{asset('home/index')}}">
						...
						<div id="logo1" style="margin-top: -88px">
				...
				<a href="{{asset('home/list/index')}}/2">
						...
						<div id="logo2" style="margin-top: -40px">
	...
	<div class="conter">
		...
		<div class="mu_wrap wrap clearfix">
			<div class="mu_nav_wrap"> 
			 	...
			 	<!-- 订单 -->
			 	<div class="mu_nav">
				  	<div class="mu_title"><a href="{{asset('home/personal/index')}}" style="color:red">我的订单</a></div> 
			    </div> 
				 <div class="mu_nav"> 
			...
			<div class="mu_content_wrap">
   				<div class="order-title">
        			<ul class="order-title-column clearfix">
			            <li style="width:25%"><a href="{{asset('home/personal/index')}}" style="color:red">全部订单</a></li>
			            <li style="width:25%"><a href="{{asset('home/personal/dfx')}}" style="color:black">待付款</a></li>
			            <li style="width:25%"><a href="{{asset('home/personal/dfh')}}" style="color:black">待发货</a></li>
			            <li style="width:25%"><a href="{{asset('home/personal/dsh')}}" style="color:black">待收货</a></li>
			...
			@if($i['id'])
	    		...
	    		<div>
	    			...
	    			@foreach($v as $ll)
	    			 @foreach($p as $s)
			            @if($ll['pid']==$s['id'])
			            <div style="width:15%;padding-top: 50px;">{{$ll['updated_at']}}</div> 
			            	@endif
		            	@endforeach
		            	@endforeach
			        @endforeach
			        ...
			        <div style="float: left;"">
			            ...
			            @foreach($p as $s)
			            @if($ll['pid']==$s['id'])
		            	<div style="width:150px;padding-left: 50px;padding-top: 50px">{{mb_substr($s['name'],5,6,'utf-8')}}</div>
		             	@endif
		            	@endforeach
		            	@endforeach
		            @endforeach
		           	...
		           	<div style ="float: left;">
			            ...
			            @foreach($p as $s)
			            @if($ll['pid']==$s['id'])
			            <div style="width:25%;padding-left: 50px;padding-top: 20px" ><img src="{{$s['image']}}" style="width:50px;"></div>
			              @endif
			            @endforeach
			            @endforeach
			        @endforeach
		           	...
		           	<div style="float: left;">
			            ...
			            @foreach($p as $s)
			            @if($ll['pid']==$s['id'])
			            <div style="width:15%;padding-top: 50px;padding-left: 100px">{{$s['price']}}</div>
			             @endif
			            @endforeach
			            @endforeach
			            @endforeach
		           ...
		           <div style = "float: left;">
			            ...
			            <div style="width:15%;padding-top: 50px;padding-left: 80px">{{$ll['pnum']}}</div>
			        @endforeach
			        @endforeach
		           </div>
		           	...
		           	<div style = "float: left;">
							...
							@if($po['did']['stat']==2)
			     			@foreach($ix as $mmm)
			     				@if($mmm['id']==$po['did']['id'])
			     			<div style="width:200px;padding-top: 50px;padding-left: 100px">未付款 <span style = "padding-left: 10px;"><a href="{{asset('home/shop/much')}}/{{$mmm['id']}}" style="color:red">去付款</a></span>
			     			<span style = "padding-left: 5px;"><a href="{{asset('home/personal/delete')}}/{{$po['did']['id']}}" style="color:red">删除</a></span></div>
			     				@endif
			     			@endforeach
			     			@elseif($po['did']['stat']==1 and $po['did']['status']==2)
			     			<div style ="width:150px;padding-top: 50px;padding-left: 100px">已付款未发货</div>
			     			@elseif($po['did']['status']==1)
			     			<div style ="width:150px;padding-top: 50px;padding-left: 100px">已发货 <span style = "padding-left: 10px;"><a href="{{asset('home/personal/shou')}}/{{$po['did']['id']}}" style="color:red">确认收货</a></span></div>
			     			@elseif($po['did']['status']==3)
			     			<div style ="width:150px;padding-top: 50px;padding-left: 100px">已收货
			     			     @foreach($p as $s)
					            	@if($po['pid']==$s['id'])
					          		 <span style = "padding-left: 10px;"><a href="{{asset('home/show/ta')}}/{{$s['id']}}" style="color:red">评价</a></span>
					             @endif
					            @endforeach
    		...
    		<div id="orderWrap">
	    		...
	    		<li>去 <a href="{{asset('home/list/index')}}/87">玫瑰</a> 看看大家都喜欢的商品</li> <li>去 <a href="{{asset('home/list/index')}}/315">饰品</a> 看看正在折扣中的商品</li> 
	    		</ul> 
	    		</div>
	    		</div>
    		</div>
