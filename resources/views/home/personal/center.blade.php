...
<div class="mu_wrap wrap clearfix">
			<div class="mu_nav_wrap"> 
				 ...
				 <div class="mu_nav"> 
			    	<div class="mu_title"><li><a href="{{asset('home/personal/center')}}" style="color:red">信息管理</a></li></div> 
			   	</div>
			    <div class="mu_nav"> 
			...
			<form action="{{asset('home/personal/upd')}}" method="post">
				 <table>
					<tr>
					<input type="hidden" value="{{$cc['id']}}" name="id">
					<td class="txtr" style="text-align: right;width: 160px;padding-right: 20px;"><span></span>昵称</td>
					<td><input id="nc" name="nc" onkeyup="calculate_complete()" class="wdxx_txt_date" type="text" value="{{$cc['nc']}}" maxlength="15" style="width: 170px;height: 30px;text-indent: 8px;border: solid 1px #83847e;color: #83847e;"></td>
				
					</tr>
					<tr>
					<td class="txtr" style="text-align: right;width: 160px;padding-right: 20px;"><span></span>生日</td>
					<td><input id="brithy" name="brithy" onkeyup="calculate_complete()" class="wdxx_txt_date" type="text" value="{{$cc['brithy']}}" maxlength="15" style="width: 170px;height: 30px;text-indent: 8px;border: solid 1px #83847e;color: #83847e;"></td>

					</tr>
					<tr>
					<td class="txtr" style="text-align: right;width: 160px;padding-right: 20px;"><span></span>住址</td>
					<td><input id="add" name="add" onkeyup="calculate_complete()" class="wdxx_txt_date" type="text" value="{{$cc['add']}}" maxlength="15" style="width: 170px;height: 30px;text-indent: 8px;border: solid 1px #83847e;color: #83847e;"></td>
					</tr>
					<tr>
					<td class="txtr" style="text-align: right;width: 160px;padding-right: 20px;"><span></span>性别</td>

					<td><input id="sex" name="sex" onkeyup="calculate_complete()" class="wdxx_txt_date" type="text" value="{{$cc['sex']}}" maxlength="15" style="width: 170px;height: 30px;text-indent: 8px;border: solid 1px #83847e;color: #83847e;"></td>
					</tr>
					<tr>
					<td class="txtr" style="text-align: right;width: 160px;padding-right: 20px;"><span></span>婚姻</td>
					<td><input id="ma" name="ma" onkeyup="calculate_complete()" class="wdxx_txt_date" type="text" value="{{$cc['ma']}}" maxlength="15" style="width: 170px;height: 30px;text-indent: 8px;border: solid 1px #83847e;color: #83847e;"></td>
					</tr>
					<tr >
					<td></td>
