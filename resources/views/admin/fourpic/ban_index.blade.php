...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
			<form class="form form-horizontal"  method="get" action="{{asset('admin/fourpic/index')}}" >
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> 
				<span class="l"> <a class="btn btn-primary radius"  href="{{asset('admin/fourpic/add')}}"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></span> 
					...
					<tbody>
						...
						<tr class="text-c">
								...
								<td class="td-manage">
									...
									<i class="Hui-iconfont">&#xe603;</i></a> 
									@endif
									<a style="text-decoration:none" class="ml-5"  href="{{asset('admin/fourpic/edit')}}/{{$v['id']}}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
function picture_stop(obj,id){
	layer.confirm('确认要禁用吗？',function(index){
		window.location.href="{{asset('/admin/fourpic/sta')}}?id="+id;
...
function picture_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		window.location.href="{{asset('/admin/fourpic/del')}}?id="+id;
		//此处请求后台程序，下方是成功后的前台处理……
