...
<div class="Hui-article-box">
	<form class="form form-horizontal" id="form-article-add" method="post" action="{{asset('/admin/banner/update')}}" enctype="multipart/form-data">
		<input type="hidden" value="{{$arr['id']}}" name="id">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片标题：</label>
			<div class="formControls col-xs-8 col-sm-5">
				<input type="text" class="input-text" value="{{$arr['title']}}" placeholder="" id="" name="title">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-5">
				<div class="uploader-thum-container">
					<span class="btn-upload form-group" style="margin-left: 0;">
					 <input class="input-text upload-url radius" type="text" name="uploadfile-1" id="uploadfile-1" value="{{$arr['image']}}" readonly>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-5">
				<div id="localImag">
		　　　　　　<img id="preview"  width="150" style="display: block;" src="{{$arr['image']}}">
		　　　　</div>
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button onClick="layer_close();" class="btn btn-default radius" type="reset"><a href="{{asset('admin/lastbanner/index')}}">&nbsp;&nbsp;取消&nbsp;&nbsp;</a></button>
			</div>
		</div>
		{{csrf_field()}}
	</form>
