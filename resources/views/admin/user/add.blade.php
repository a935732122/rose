...
<div class="Hui-article-box">
	<form class="form form-horizontal" id="form-article-add" method="post" action="{{asset('/admin/user/insert')}}" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-5">
				 <input type="password" class="input-text" name="password"  placeholder="" value="{{ old('password') }}">
			</div>
		</div>
