...
<div class="Hui-article-box">
	<form class="form form-horizontal" id="form-article-add" method="post" action="{{asset('/admin/role/insert')}}" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
				      ...
				      @foreach($permissions as $permission)
				        ...
				        <input type="checkbox" value="{{ $permission['id'] }}" name="permission[]" > {{ $permission['display_name'] or $permission['name'] }}
